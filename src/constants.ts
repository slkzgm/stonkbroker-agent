...
export const UNISWAP_UNIVERSAL_ROUTER = getAddress(
  "0x8876789976decbfcbbbe364623c63652db8c0904",
);

// Official deterministic proxy used by Uniswap's x-permit2-disabled flow.
export const UNISWAP_SWAP_PROXY = getAddress(
  "0x0000000085E102724e78eCd2F45DC9cA239Affad",
);

export const DEFAULT_STONKBROKER_NFT = getAddress(
  "0x539CdD042c2f3d93EbC5BE7DfFf0c79F3B4fAbF0",
);

export const KNOWN_STONKBROKER_ACCOUNT_IMPLEMENTATION = getAddress(
  "0xE946075125843aAdb5e40e59f513d929AF507C4B",
);
...
export const asAddress = (value: string): Address => getAddress(value);
